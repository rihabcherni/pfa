...
export default function NotificationAgent() {
  ...
  return (
    <div style={{width:"100%"}}>
        <Api nom='notification' tableNamePlu='notification' tableNameSing='Liste notification' url={url} initialValue={initialValue} columnDefs={columnDefs} show={show} createUpdate={createUpdate}/>  
    </div>
  );
}
