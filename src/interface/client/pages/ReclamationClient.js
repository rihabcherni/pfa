...
export default function PanneHistorique() {
  ...
  return (
    <div style={{width:"100%"}}>
        <Api nom='reclamation' tableNamePlu='reclamation' tableNameSing='Liste reclamation' url={url} initialValue={initialValue} columnDefs={columnDefs} show={show} createUpdate={createUpdate}/>  
    </div>
  );
}
